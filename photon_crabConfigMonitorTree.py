...
config.General.requestName = 'monitorSkim_9Aug_2022F'

config.JobType.pluginName = 'Analysis'
# Name of the CMSSW configuration file
config.JobType.psetName = 'packedPFcandidates_pho_monitor.py'
...
config.Data.outputDatasetTag = 'monitorSkim_9Aug_2022F'
